...
use crate::core::DaysCore;

#[get("")]
pub async fn select_days(query: web::Query<DaysModel>, mut session: Session) -> impl Responder {
    ...
    match DaysCore::select_day(query.0, false).await {
